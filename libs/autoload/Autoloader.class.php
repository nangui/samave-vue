...
class Autoloader
{
    ...
    public static function autoload($class)
    {
        ...
        elseif (file_exists('src/entities/'.$class.'.class.php')) {
            require_once 'src/entities/'.$class.'.class.php';
        } elseif (file_exists('src/controller/'.$class.'.class.php')) {
            require_once 'src/controller/'.$class.'.class.php';
        } elseif (file_exists('src/model/'.$class.'.class.php')) {
        ...
        //for namespaces
        elseif (file_exists(str_replace('\\', '/', $class.'.class.php'))) {
            require_once str_replace('\\', '/', $class.'.class.php');
        } elseif (file_exists(str_replace('\\', '/', $class.'.php'))) {
            require_once str_replace('\\', '/', $class.'.php');
        } elseif (file_exists(str_replace('\\', '/', $class.'.lib.class.php'))) {
